...
station_init(struct station *station)
{
    ...
    pthread_cond_init(&station->passengerReady, NULL);
}
...
station_load_train(struct station *station, int countOfEmptySeatsOnTheArrivedTrain)
{
    ...
    while(station->numberOfEmptySeats > 0 && station->numberOfWaitingPassengers > 0){                                   //printf("line 20 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
        ...
        pthread_cond_wait(&station->passengerReady, &station->mutex);                                               //printf("line 22 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
...
station_wait_for_train(struct station *station)
{
    ...
    station->numberOfWaitingPassengers--;                                                                               //printf("line 35 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
    ...
    pthread_mutex_unlock(&station->mutex);                                                                              //printf("line 37 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
}

void
station_on_board(struct station *station)
{
    pthread_mutex_lock(&station->mutex);                                                                                //printf("line 43 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
    station->numberOfPassengersWalkingOnTrain--;                                                                        //printf("line 44 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
    ...
    if(station->numberOfEmptySeats == 0 || station->numberOfPassengersWalkingOnTrain == 0)                              //printf("line 46 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
        pthread_cond_signal(&station->passengerReady);                                                              //printf("line 47 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
    pthread_mutex_unlock(&station->mutex);                                                                              //printf("line 48 , numberOfEmptySeats = %d, numberOfWaitingPassengers = %d, numberOfPassengersWalkingOnTrain = %d \n",station->numberOfEmptySeats, station->numberOfWaitingPassengers, station->numberOfPassengersWalkingOnTrain);
}
